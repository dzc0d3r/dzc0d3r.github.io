    ...
    <div className="container mx-auto">
      <div>
        ...
        <div className="mb-0 sm:mb-2 flex flex-col lg:flex-row justify-between items-center gap-y-1 ">
          <Link href={'/'}>
            <h1 className="text-2xl sm:text-4xl leading-[3rem] font-semibold font-sora">walid <span className="font-extralight">lamraoui</span><span className="text-accent">.</span></h1>
          </Link>
